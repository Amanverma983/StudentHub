  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-lg glass-card rounded-[2.5rem] p-8 border border-glass-border shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h3 className="font-display text-2xl font-800 text-ink">Free Checkout</h3>
            <p className="text-xs text-ink-muted">Scan & Pay via UPI (No Gateway Fees)</p>
          </div>
        </div>
        ...
        {/* Upload Section */}
        <div className="mt-8 pt-8 border-t border-glass-border space-y-5">
           <div>
          ...
          <Button 
            ...
            disabled={!proof || !transactionId || isUploading}
